const config ={
    ...
    VITE_APPWRITE_USERS_COLLECTION_ID: String(import.meta.env.VITE_APPWRITE_USERS_COLLECTION_ID),
    VITE_APPWRITE_BLOGS_BUCKET_ID : String(import.meta.env.VITE_APPWRITE_BLOGS_BUCKET_ID)
}
